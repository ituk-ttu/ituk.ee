...
<template>
    <a :href="link" target="_self" aria-label="ITÜK Facebook" class=" w-12 h-12 justify-center items-center flex">
        <svg aria-label="Facebook logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="currentColor"
            class="text-white hover:text-[#1868fc] transition-colors duration-150">
            <path id="facebook"
