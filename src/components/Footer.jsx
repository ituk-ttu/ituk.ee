  ...
  return (
    <div className="footer">
      <div className="container">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3">
          <div class="grid col-span-1 justify-center place-items-center">
            <li>
              <MdLocationPin />
          ...
          <div class="flex col-span-1  justify-center place-items-center gap-6">
            ...
            >
              ...
              <span class="sr-only">Hub page</span>
            </a>
            ...
            >
              ...
              <span class="sr-only">Drive link</span>
            </a>
            <a
