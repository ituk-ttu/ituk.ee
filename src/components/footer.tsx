      ...
      <footer className="z-50 main-container main-padding dark shadow-filled justify-between items-center flex-col gap-auto md:flex-row gap-32 md:gap-auto flex">
        <div className="justify-between items-start gap-4 flex-col flex">
          <div className="justify-start items-center gap-4 flex-row flex">
            ...
            <a href="mailto:kontakt@ituk.ee" className="font-bold underline">kontakt@ituk.ee</a>
          </div>
          <div className="justify-start items-center gap-4 flex-row flex">
            <Image src={phone} alt="Phone number" />
            <a href="tel:+37256931193" className="font-bold underline">+372 5693 1193</a>
          </div>
          <div className="justify-start items-center gap-4 flex-row flex">
            <Image src={location} alt="Our office" />
            <a href="https://www.google.com/maps/place/TalTech+IT+College/@59.3954482,24.6617187,17z/data=!3m1!4b1!4m6!3m5!1s0x469295a90aee413b:0x4f990fb010829ae5!8m2!3d59.3954455!4d24.6642936!16s%2Fm%2F0j24704?entry=ttu&g_ep=EgoyMDI1MDEyMi4wIKXMDSoASAFQAw%3D%3D" className="font-bold underline">
