    ...
    <div className=" items-start flex-col sm:flex-row flex">
      ...
      >
        <div className="triple-height sm:h-screen main-max w-full bg-black/50 hover:bg-primary/50 transition-colors duration-150 ease-in-out justify-center items-center flex-row flex">
          <h2 className="p-8 text-lead text-center">{dictionary.education}</h2>
        </div>
      </Link>
      <Link
      ...
      >
        <div className="triple-height sm:h-screen main-max w-full bg-black/50 hover:bg-primary/50 transition-colors duration-150 ease-in-out justify-center items-center flex-row flex">
          <h2 className="p-8 text-lead text-center">{dictionary.entertainment}</h2>
        </div>
      </Link>
      <Link
      ...
      >
        <div className="triple-height sm:h-screen main-max w-full bg-black/50 hover:bg-primary/50 transition-colors duration-150 ease-in-out justify-center items-center flex-row flex">
          <h2 className="p-8 text-lead text-center">{dictionary.other}</h2>
        </div>
      </Link>
    </div>
  );
