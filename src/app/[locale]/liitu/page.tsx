...
export default function Home() {
    ...
    return (
        <div>
            ...
            <div className="max-w-screen-xl mx-auto flex flex-col justify-center items-center px-16 py-16 gap-16">
                <h1>{dictionary.text1}</h1>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16">
                    <div className="bg-primary rounded-lg max-w-72 w-auto">
            ...
            <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-center items-start px-16 py-6 gap-8">
                <div className="md:w-2/3 flex justify-center">
                    <img src={koostoo.src} className="rounded-lg shadow-lg mb-4 max-w-full h-auto" />     
                </div>
