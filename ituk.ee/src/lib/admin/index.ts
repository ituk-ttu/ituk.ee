...
export async function deleteTimelineEvent(id: string): Promise<boolean> {
    return deleteDocument('timeline-events', id);
}

// Event operations
export async function saveEvent(data: Record<string, string>): Promise<boolean> {
    return saveDocument('events', data, 'Üritus edukalt salvestatud!');
}
...
export async function deletePartner(id: string): Promise<boolean> {
    return deleteDocument('partners', id);
}
