    ...
    {#each rows() as row, rowIndex}
        ...
        <div class="flex items-stretch">
            ...
            {#if isFirstRow}
                ...
                <div
                    class="w-[128px] h-[460px] shrink-0 flex flex-col gap-4 pb-[352px]"
                >
            ...
            {:else if isEvenRow}
                ...
                <div
                    class="w-[128px] h-[460px] shrink-0 flex flex-col items-start pb-[362px] pl-[90px]"
                >
            ...
            {:else}
                ...
                <div
                    class="w-[128px] h-[460px] shrink-0 flex flex-col items-start pt-[94px] pl-[90px]"
                >
                    <div class="h-1 w-full bg-white"></div>
                    <div class="w-1 flex-1 bg-white"></div>
                </div>
            ...
            {#each displayItems as item, cardIndex}
                ...
                {#if cardIndex < cardsInRow - 1}
                    <div class="w-[128px] h-[460px] shrink-0 pt-[85px]">
            ...
            {:else if isEvenRow}
                ...
                <div
                    class="w-[128px] h-[460px] shrink-0 flex flex-col items-end pt-[94px] pr-[90px]"
                >
                    <div class="h-1 w-full bg-white"></div>
                    <div class="w-1 flex-1 bg-white"></div>
                </div>
            {:else}
                ...
                <div
                    class="w-[128px] h-[460px] shrink-0 flex flex-col items-end pb-[362px] pr-[90px]"
                >
