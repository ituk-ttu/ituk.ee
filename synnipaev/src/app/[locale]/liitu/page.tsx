        ...
        <div>
            ...
            <div className="flex flex-col justify-center items-center px-16 py-32 gap-16">
                ...
                <div className="flex flex-row items-center gap-16">
                    ...
                    <Card title={dictionary.card2.title} image={meened.src} description={dictionary.card2.description} board={false} />
                    <Card title={dictionary.card3.title} image={sobrad.src} description={dictionary.card3.description} board={false} />
                    <Card title={dictionary.card4.title} image={muu.src} description={dictionary.card4.description} board={false} />
                </div>
