        ...
        Nii saame veenduda, et kesiganes edasi manageerima peab, saab ise hakkama ja ei pea talveunest äratama väiksema probleemi peale ;D */}
          ...
          <div className="justify-center items-center text-align gap-16 flex-col flex">
            ...
            <div className="w-full justify-center items-start flex-col md:flex-row flex gap-16">
              ...
              >
                <label className="text-center">Loo uus üritus</label>
                <input
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Handle (nt: dont-do-it)"
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Banner link (nt: /events/ddit.jpg)"
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Kategooria (nt: meelelahutus)"
                ...
                <input
                  ...
                  type="text"
                  required
                  placeholder="Sisutekst (nt: DDIT go brr)"
